...
https://github.com/david-stojanovski/echo_from_noise?tab=readme-ov-file

The code has been further adapted to support B-maps and curvilinear probes.
"""
...
from src.guided_diffusion.losses import normal_kl, discretized_gaussian_log_likelihood
from src.guided_diffusion.nn import mean_flat
...
def camus_fan_param(matrix_width):
    # Define the fan array parameters for the CAMUS dataset
...
class GaussianDiffusion:
    ...
    Further adapted to support B-maps and curvilinear probes.
    ...
    def q_sample(self, x_start, t, noise=None):
        ...
        return q_mean + q_variance * noise
    ...
    def p_mean_variance(
        ...
        if self.model_var_type in [ModelVarType.LEARNED, ModelVarType.LEARNED_RANGE]:
            ...
            if self.model_var_type == ModelVarType.LEARNED:
                ...
                min_log = posterior_log_variance_clipped_t
    ...
    def _predict_xstart_from_eps(self, x_t, t, eps):
        ...
        x_0 = sqrt_recip_alphas_cumprod_t * x_t - sqrt_recipm1_alphas_cumprod_t * eps
    ...
    def p_sample_loop_progressive(
        ...
        p_sample().
        """
        print("p_sample_loop_progressive function")
        if device is None:
...
def _extract_into_B_tensor(matrix_schedule, timesteps):
    """
    Extract values from a list of pre-scheduled matrices for a batch of indices.

    :param matrix_schedule: the list of pre-scheduled matrices, with size: [T, C, H, W]
    :param timesteps: a tensor of indices into the array to extract.
