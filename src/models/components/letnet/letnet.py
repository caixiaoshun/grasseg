...
from src.models.components.letnet.module.transformer import TransBlock
from src.models.components.letnet.module.patch import reverse_patches
...
if __name__ == '__main__':
    ...
    x = torch.randn(size=(2,3,512,512)).to(device)
